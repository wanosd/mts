...
public class JDBCTests {
	...
	public void testCreateRetrieve(){
		...
		userDAO.createUserJDBC(user2);
		userDAO.createUserJDBC(user3);
		userDAO.createUserJDBC(user4);
		
		List<User> users2 = userDAO.getAllUsersJDBC();
