...
<div class="admin">
<ul>
<li><a href="${pageContext.request.contextPath}/approveMembers" class="adminLink">Approve Member</a> - This page should bring up a list of all members who have registered but do not have access to the site)</li>
<li><a href="${pageContext.request.contextPath}/blockMembers" class="adminLink">Block Member</a> - This page will list all members who are accepted, but could be blocked for non payment, leaving club etc. Exclude admin categories</li>
<li><a href="${pageContext.request.contextPath}/createTournament" class="adminLink">Create Tournament</a></li>
