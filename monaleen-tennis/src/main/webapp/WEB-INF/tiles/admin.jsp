...
<a href="${pageContext.request.contextPath}/approveMembers" class="adminLink">Approve Member</a> - This page should bring up a list of all members who have registered but do not have access to the site)
