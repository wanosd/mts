...
<tr><td>Email:</td><td><sf:input name = "username" path="username" type="text"/><br/><sf:errors path="name" cssClass="error"></sf:errors></td></tr>
<tr><td>Password:</td><td><sf:input name = "password" path="password" type="text"/><br/><sf:errors path="password" cssClass="error"></sf:errors></td></tr>
...
<tr><td>Role</td><td><sf:select path="authority"><sf:options items="${roles }"/></sf:select>
