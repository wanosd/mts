...
<tr><td>Tournament Name</td><td><sf:input name = "tournamentName" path="tournamentName" type="text"/><br/><sf:errors path="tournamentName" cssClass="error"></sf:errors></td></tr>
